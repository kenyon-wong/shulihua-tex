...
\caption{图2.12（a）一列简谐波在 \(t = t_{1}\) 时的波形图线}
\end{figure}
...
\caption{图2.12（b）距波源 \(r=r_{1}\) 的质点 P 的振动图线}
\end{figure}
...
\centering
\fitfig{%
% fig-alt: 图5.13(a) 烧瓶在水槽中，左温度计，右接 U 形水银压强计，开口端水银面较高
\begin{tikzpicture}[line cap=round,line join=round,>=stealth,every node/.style={inner sep=1pt}]
  % bath
...
\centering
\fitfig{%
% fig-alt: 图5.13(b) 烧瓶在冰水槽中，U 形压强计左臂水银面标 A，右臂较高；图内无温度计
\begin{tikzpicture}[line cap=round,line join=round,>=stealth,every node/.style={inner sep=1pt}]
  \draw[line width=0.8pt] (0.15,0.20) -- (0.15,3.55) -- (3.35,3.55) -- (3.35,0.20) -- cycle;
  % ice
...
\caption{图6.13 观察气体压强随温度变化而变化的装置}
\end{figure}
...
\centering
\fitfig{%
% fig-alt: 图5.16(a) 带活塞汽缸，活塞约在中部，其下气体为疏点，无电炉。正文图题仍是 (a)
\begin{tikzpicture}[line cap=round,line join=round,>=stealth,every node/.style={inner sep=1pt}]
  ...
  \fill (0.28,0.72) circle[radius=0.013];
  \fill (0.52,0.72) circle[radius=0.013];
  \fill (0.76,0.72) circle[radius=0.013];
  \fill (1.00,0.72) circle[radius=0.013];
  \fill (1.24,0.72) circle[radius=0.013];
  \fill (1.48,0.72) circle[radius=0.013];
  \fill (1.72,0.72) circle[radius=0.013];
  \fill (1.96,0.72) circle[radius=0.013];
  \fill (0.39,0.92) circle[radius=0.013];
  \fill (0.63,0.92) circle[radius=0.013];
  \fill (0.87,0.92) circle[radius=0.013];
  \fill (1.11,0.92) circle[radius=0.013];
  \fill (1.35,0.92) circle[radius=0.013];
  \fill (1.59,0.92) circle[radius=0.013];
  \fill (1.83,0.92) circle[radius=0.013];
  \fill (2.07,0.92) circle[radius=0.013];
  \fill (0.28,1.12) circle[radius=0.013];
  \fill (0.52,1.12) circle[radius=0.013];
  \fill (0.76,1.12) circle[radius=0.013];
  \fill (1.00,1.12) circle[radius=0.013];
  \fill (1.24,1.12) circle[radius=0.013];
  \fill (1.48,1.12) circle[radius=0.013];
  \fill (1.72,1.12) circle[radius=0.013];
  \fill (1.96,1.12) circle[radius=0.013];
  \fill (0.39,1.32) circle[radius=0.013];
  \fill (0.63,1.32) circle[radius=0.013];
  \fill (0.87,1.32) circle[radius=0.013];
  \fill (1.11,1.32) circle[radius=0.013];
  \fill (1.35,1.32) circle[radius=0.013];
  \fill (1.59,1.32) circle[radius=0.013];
  \fill (1.83,1.32) circle[radius=0.013];
  \fill (2.07,1.32) circle[radius=0.013];
  \fill (0.28,1.52) circle[radius=0.013];
  \fill (0.52,1.52) circle[radius=0.013];
  \fill (0.76,1.52) circle[radius=0.013];
  \fill (1.00,1.52) circle[radius=0.013];
  \fill (1.24,1.52) circle[radius=0.013];
  \fill (1.48,1.52) circle[radius=0.013];
  \fill (1.72,1.52) circle[radius=0.013];
  \fill (1.96,1.52) circle[radius=0.013];
  \fill (0.39,1.72) circle[radius=0.013];
  \fill (0.63,1.72) circle[radius=0.013];
  \fill (0.87,1.72) circle[radius=0.013];
  \fill (1.11,1.72) circle[radius=0.013];
  \fill (1.35,1.72) circle[radius=0.013];
  \fill (1.59,1.72) circle[radius=0.013];
  \fill (1.83,1.72) circle[radius=0.013];
  \fill (2.07,1.72) circle[radius=0.013];
...
\centering
\fitfig{%
% fig-alt: 图5.16(b) 同一汽缸活塞固定，其下气体为疏点，底部电炉。正文图题仍是 (b)
\begin{tikzpicture}[line cap=round,line join=round,>=stealth,every node/.style={inner sep=1pt}]
  \draw[line width=0.75pt] (0.15,0.55) -- (0.15,3.55);
  \draw[line width=0.75pt] (2.25,0.55) -- (2.25,3.55);
  \draw[line width=0.75pt] (0.15,0.55) -- (2.25,0.55);
...
\fitfig{%
\begin{tikzpicture}[line cap=round,line join=round]
  \foreach \p in {(0,0),(0.4,0.2),(0.2,0.5)} \fill \p circle (1.2pt);
\end{tikzpicture}%
}
\caption{图5.18}
\end{figure}
...
\centering
\fitfig{%
% fig-alt: 图5.18(a) 带活塞汽缸，气柱较短，活塞上有宽黑块，无电炉。正文图题仍是 (a)
\begin{tikzpicture}[line cap=round,line join=round,>=stealth,every node/.style={inner sep=1pt}]
...
\centering
\fitfig{%
% fig-alt: 图5.18(b) 加热后活塞上升，气柱最高，活塞上有小黑块，底部电炉。正文图题仍是 (b)
\begin{tikzpicture}[line cap=round,line join=round,>=stealth,every node/.style={inner sep=1pt}]
  \draw[line width=0.75pt] (0.15,0.55) -- (0.15,3.85);
  \draw[line width=0.75pt] (2.25,0.55) -- (2.25,3.85);
  \draw[line width=0.75pt] (0.15,0.55) -- (2.25,0.55);
...
\centering
\fitfig{%
% fig-alt: 图5.18(c) 汽缸气柱中等，活塞上有阶梯状黑块，底部电炉。正文图题仍是 (c)
\begin{tikzpicture}[line cap=round,line join=round,>=stealth,every node/.style={inner sep=1pt}]
  \draw[line width=0.75pt] (0.15,0.55) -- (0.15,3.85);
  \draw[line width=0.75pt] (2.25,0.55) -- (2.25,3.85);
  \draw[line width=0.75pt] (0.15,0.55) -- (2.25,0.55);
...
\fitfig{%
\begin{tikzpicture}[line cap=round,line join=round]
  \draw[line width=0.7pt] (0,0.7) rectangle (1.8,1.1);
  \foreach \x in {0.3,0.7,1.1,1.5} \draw[line width=0.45pt] (\x,0.15) -- (\x,0.7);
\end{tikzpicture}%
}
\caption{图9.10 大型水管式锅炉设备示意图}
\end{figure}
...
\centering
\fitfig{%
% fig-alt: 图9.22 单级蒸汽轮机转子剖面：轴（1）穿叶轮盘（2），外沿弧形叶片（3），斜喷管（4）对叶片
\begin{tikzpicture}[line cap=round,line join=round,>=Stealth,every node/.style={inner sep=1pt,font=\scriptsize}]
  % 叶轮盘（侧视，横线示厚盘）
...
\fitfig{%
\begin{tikzpicture}[line cap=round,line join=round]
  \draw[line width=0.7pt] (0,0.5) circle (0.55);
  \foreach \a in {0,45,...,315} \draw[line width=0.4pt] (0,0.5) -- ++(\a:0.55);
\end{tikzpicture}%
}
\caption{图9.22（a）单级蒸汽轮机的转子（1---机轴；8---叶轮；3---叶片；4---喷管）}
\end{figure}
...
\fitfig{%
\begin{tikzpicture}[line cap=round,line join=round]
  \draw[line width=0.7pt] (0,0) rectangle (1.0,1.3);
  \draw[line width=0.55pt] (0.15,0.3) rectangle (0.85,0.7);
  \draw[line width=0.5pt] (0.5,0.7) -- (0.5,1.15);
\end{tikzpicture}%
}
\caption{图9.20 单缸四冲程汽托内燃机剖面图}
\end{figure}
