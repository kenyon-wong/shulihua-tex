...
\caption{图 1.18 表示简谐振动 \(x_{2}=A_{2}\cos (\omega t + \varphi_{2})\) 的旋转矢量}
\end{figure}
...
\caption{图 1.19 利用旋转矢量合成法作出在一直线上两个频率相同的简谐振动的合振动图线}
\end{figure}
...
\caption{图 2.19 在干涉图样中形式波腹和波节的条件}
\end{figure}
...
\caption{图 2.26 运用惠更斯原理解释波的衍射现象}
\end{figure}
...
\caption{图 4.2 确定水银温度计的\(100^{\circ}\)C 刻度和\(0^{\circ}\)C 刻度}
\end{figure}
...
\caption{图 6.13 观察气体压强随温度变化而变化的装置}
\end{figure}
...
\caption{图 7.8 浸润液体和不浸润液体在容器里的弯月面}
\end{figure}
...
\caption{图 7.10 在内径越小的毛细管中，毛细现象越显著}
\end{figure}
...
\caption{图 7.14 云母片的各向异性和玻璃片的各向同性}
\end{figure}
...
\caption{图 8.11 测定水的汽化热的实验装置（A---蒸汽锅；B·汽室；C---显热器）}
\end{figure}
...
\caption{图 9.22 单级蒸汽轮机的转子（1---机轴；8---叶轮；3---叶片；4---喷管）}
\end{figure}
...
\caption{图 9.33 燃气轮机的示意图（1---空气压缩机；2---燃烧室；3---高压油泵；4---喷油嘴；5---喷管；6---轮机；7---往烟囱通道）}
\end{figure}
